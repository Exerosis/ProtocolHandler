...
public class PacketEventOutRelEntityMoveLook extends PacketEventOutRelEntityMove {
    /*
    double yaw
    double pitch
     */

    public PacketEventOutRelEntityMoveLook(Object packet, PacketPlayer player) {
        super(packet, player);
    }
